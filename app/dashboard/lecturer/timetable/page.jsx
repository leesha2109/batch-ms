        ...
        <div className="px-6 py-5 space-y-4">
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setForm((p) => ({ ...p, subjectAssignmentId: e.target.value }))
              }
...
export default function LecturerTimetablePage() {
  ...
  useEffect(() => {
    ...
    fetch(
      `/api/timetable?batchId=${selBatch}&semesterNumber=${semesterNumber}&year=${currentYear}`,
    )
      .then((r) => r.json())
      .then((d) => {
        ...
        {selBatch && selLevel && selSemester ? (
          <>
                        ...
                        >
                          ...
                          {TIMES.slice(0, -1).map((t, i) => {
                            ...
                            return (
                              ...
                              >
                                <span className="hidden group-hover:flex items-center justify-center h-full text-gray-300 text-xs">
                                  +
                                </span>
                              </div>
                            );
                            ...
                            .map((slot) => {
                              ...
                              return (
                                <div
                                  ...
                                  onClick={() =>
                                    handleCellClick(day, slot.startTime)
                                  }
            ...
            <p className="text-xs text-gray-400 mt-3">
              Click any empty slot to assign a subject. Click a colored block to
              change or clear it.
            </p>
          </>
        ) : (
