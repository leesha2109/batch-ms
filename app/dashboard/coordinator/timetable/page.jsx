            ...
            >
              ...
              {allLecturers.map((l) => (
                <option key={l._id} value={l._id}>
                  {l.name} (
                  {l.role === "visiting_lecturer" ? "Visiting" : "Confirmed"})
                </option>
              ))}
            </select>
          </div>
                    ...
                    {filtered.length === 0 ? (
                      ...
                      filtered.map((s) => (
                        ...
                        >
                          ...
                          <td className="px-5 py-3">
                            <span
                              className={`text-xs px-2 py-0.5 rounded-full font-medium ${PROG_COLORS[s.programme]}`}
                            >
                              {s.programme}
                            </span>
                          </td>
                          <td className="px-5 py-3">
                            <div className="flex gap-3 justify-end">
                              ...
                              <button
                                onClick={async () => {
                                  if (!confirm("Deactivate this subject?"))
                                    return;
